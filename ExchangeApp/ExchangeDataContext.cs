...
namespace ExchangeApp
{
    ...
    public class ExchangeDataContext
    {
        ...
        public GetUserAvailabilityResults GetAvailabilty(string organizer, List<string> requiredAttendees, int meetingDuration, int timeWindowDays)
        {
            ...
            GetUserAvailabilityResults results = _service.GetUserAvailability(attendees, new TimeWindow(DateTime.Now, DateTime.Now.AddDays(timeWindowDays)), AvailabilityData.FreeBusyAndSuggestions, options);
